...
class TestBaseHelperViewMethods(DexterityIntegrationTests):
    ...
    def test_display_phone(self):
        ...
        self.assertEqual(self.view.display_phone(phone=u"abcdefgh"), u"Numéro de téléphone non reconnu: 'abcdefgh'")
        ...
        self.assertEqual(
            self.view.display_phone(phone="081000000", country="FR"), u"Numéro de téléphone non valide: '081000000'"
        )
        ...
        self.assertEqual(
            self.view.display_phone(phone="081000000", format="int", pattern=[[], ["-", "."]]), u"+32-81.00.00.00"
        )
        self.assertEqual(
            self.view.display_phone(phone="081000000", format="int", pattern=[["."], ["-", "."]]), u"+32-81.00.00.00"
        )
        self.assertEqual(self.view.display_phone(phone="081000000", format="int", pattern=[["."]]), u"+32 81 00 00 00")
        self.assertEqual(
            self.view.display_phone(phone="081000000", format="int", pattern=[[], [" (0)", " "]]), u"+32 (0)81 00 00 00"
        )
